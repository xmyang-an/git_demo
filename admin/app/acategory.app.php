...
class AcategoryApp extends BackendApp
{
    ...
    function add()
    {
        ...
        else
        {
            ...
            {
                $this->json_error('cannot_be_parent');
                return;
            }
            ...
            if (!$cate_id)
            {
				$error = current($this->_acategory_mod->get_error());
                $this->json_error($error['msg']);
                return;
            }

            $this->json_result(array('ret_url'=>'index.php?app=acategory'),'add_ok');
        }
    }
    ...
    function edit()
    {
        ...
        else
        {
            ...
            $this->json_result(array('ret_url'=>'index.php?app=acategory'),'edit_ok');
        }
    }
   ...
   function ajax_col()
   {
    ...
    function drop()
    {
        ...
        if (!$id)
        {
            $this->json_error('no_acategory_to_drop');
            return;
        }
