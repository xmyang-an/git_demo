...
class ModuleApp extends BackendApp
{
    ...
    function install()
    {
        ...
        else
        {
            ...
            $this->json_result(array('ret_url'=>'index.php?module='. $data['module_id'] . '&act=index'),'install_module_successed');
        }
    }
    ...
    function uninstall()
    {
        ...
        $this->json_result('','uninstall_module_successed');
    }
    ...
    function config()
    {
        ...
        else
        {
            ...
            $this->json_result('','config_module_successed');
        }
    }
