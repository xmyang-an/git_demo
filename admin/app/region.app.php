...
class RegionApp extends BackendApp
{
    ...
    function add()
    {
        ...
        else
        {
            ...
            if (!$region_id)
            {
				$error = current($this->_region_mod->get_error());
            	$this->json_error($error['msg']);
                return;
            }

            $this->json_result(array('ret_url'=>'index.php?app=region'),'add_ok');
        }
    }
    ...
    function edit()
    {
        ...
        else
        {
            ...
            if (empty($region))
            {
                $this->json_error('no_such_region');
            ...
            if ($region['parent_id'] != $data['parent_id'])
            {
                ...
                {
                    $this->json_error('path_depth_error');
            ...
            $this->json_result(array('ret_url'=>'index.php?app=region'),'edit_ok');
        }
    }
   ...
   function ajax_col()
   {
    ...
    function drop()
    {
        ...
        if (!$id)
        {
            $this->json_error('no_region_to_drop');
            return;
        }
    ...
    function import()
    {
        ...
        else
        {
            ...
            $this->json_result(array('ret_url'=>'index.php?app=region'),'import_ok');
        }
    }
