...
function addHistoryItem(tab, item){
    ...
    if($(id).length == 1){
        ...
        var lnk = $('<a href="javascript:;" id="' + tab + '-' + item + '"><i class="iconfont '+menu[tab]['children'][item]['ico']+'"></i>' + menu[tab]['children'][item]['text'] + '</a>');
...
function loadSubmenu(){
    ...
    $.each(m.children, function(k, v){
        ...
        var item = $('<dd><a href="javascript:;" url="' + v.url + '" parent="' + p + '" id="item_' + k + '"><i class="iconfont '+v.ico+'"></i>' + v.text + '</a></dd>');
