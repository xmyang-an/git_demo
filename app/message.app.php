...
class MessageApp extends MemberbaseApp
{
    ...
    function newpm()
    {
        ...
        /* 当前位置 */
        $this->_curlocal(LANG::get('message'),         'index.php?app=message&amp;act=newpm',
                         LANG::get('newpm')
                         );
    ...
    function privatepm()
    {
        ...
        $this->_config_seo('title', Lang::get('member_center') . ' - ' . Lang::get('privatepm'));
        $this->display('message.box.html');
    }
    ...
    function systempm()
    {
        ...
        $this->_config_seo('title', Lang::get('member_center') . ' - ' . Lang::get('systempm'));
        $this->display('message.box.html');
    }
    ...
    function announcepm()
    {
        ...
        $this->_config_seo('title', Lang::get('member_center') . ' - ' . Lang::get('announcepm'));
        $this->display('message.box.html');
    }
    /**
     *    发送短消息
