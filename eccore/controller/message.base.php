...
class Message extends MessageBase
{
    ...
    function report_link($err, $msg, $file, $line)
    {
        if (strncmp($msg, 'MySQL Error[', 12) == 0)
        {
            ...
            $this->add_link(Lang::get('mysql_error_report'));
        }
        else
        {
            ...
            $url = 'index.php?app=issue&data=' . $str_report . '&amp;sign=' . md5($str_report);
    ...
    function display($f = '')
    {
        ...
        else
        {
            ...
            $this->_config_seo('title', Lang::get('sysmsg'));
			...
			$this->assign('curlocal_title', Lang::get('sysmsg'));
