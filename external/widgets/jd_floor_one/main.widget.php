 ...
 * 商品模块挂件
 */
class Jd_floor_oneWidget extends BaseWidget
{
    var $_name = 'jd_floor_one';
    ...
    function _get_data()
    {
			...
			$data=array(
				...
				'cates'=>$cates,
				'ads' => Psmb_init()->Jd_widget_get_ads($this->options,8),
				'slides' => $this->options['slides'],
				'goods_list' => Psmb_init()->Jd_widget_get_tabs_goods($this->options['tabs'],8), 
			);
