...
class PHPExcel_Calculation {
	...
	public $_savedPrecision	= 14; // modify by MiMall for notice :Cannot access property PHPExcel_Calculation::$_savedPrecision
	...
	public function __destruct() {
		...
		if (@$this->_savedPrecision != ini_get('precision')) {// modify by MiMall for notice :Cannot access property PHPExcel_Calculation::$_savedPrecision
