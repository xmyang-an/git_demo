(function($){
	$.fn.compressUpload = function(options){
		var defaults = {auto: true, swf: 'Uploader.swf', server: '', fileVal: 'file', pick: '#picker', multiple: false, compress: true, compressWidth:400, compressHeight:400, crop: true, compressSize: 0, callback : function(){}};
