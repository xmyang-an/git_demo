...
class StoreModel extends BaseModel
{
    ...
    function get_info($store_id)
    {
		...
		if(!empty($info['store_slides'])){
			$info['store_slides'] = json_decode($info['store_slides'],true);
		}
		if(!empty($info['wap_store_slides'])){
			$info['wap_store_slides'] = json_decode($info['wap_store_slides'],true);
		}
        return $info;
    }
