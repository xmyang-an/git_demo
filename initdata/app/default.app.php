...
class DefaultApp extends BaseApp
{
    ...
    function index()
    {
        ...
        else
        {
            ...
            /* 注册用户 */
            $this->_seller_id = $ms->user->register($seller_name, '123456789', 'testBusiness@mimall.com', array('real_name' => '测试卖家'));
            $this->_buyer_id  = $ms->user->register($buyer_name, '123456789', 'testBuyer@mimall.com', array('real_name' => '测试买家'));
