...
$(function(){
    $('#article_relate').click(function(){
        $('.relate').attr('checked', $(this).prop('checked'));
    });
});
</script>
<div id="rightTop">
...
?>
           ...
           <th></th>
           <?php endif; ?>
           <td class="paddingT15 floatleft wordSpacing5" style="width:150px;" >
...
?>
      ...
      <tr>
        <th></th>
        <td class="ptb20" colspan="2"><input class="formbtn J_FormSubmit" type="submit" name="Submit" value="提交" />
          <input class="formbtn formbtn1" type="reset" name="Reset" value="重置" />        </td>
      </tr>
    </table>
  </form>
</div>
