...
?>
        ...
        <tr>
            ...
            <td class="paddingT15 wordSpacing5">
            <input name="vol_size" value="<?php echo $this->_var['vol_size']; ?>" type="text" />
        ...
        <tr>
            ...
            <td class="paddingT15 wordSpacing5">
             <input name="backup_name" value="<?php echo $this->_var['backup_name']; ?>" type="text"  />
        ...
        <tr>
            <th></th>
            <td class="ptb20">
                <input class="formbtn" type="button" value="提交" onclick=" submitConfirm('为保证数据完整性请确保您的站点处于关闭状态，您确定要马上执行当前操作吗？',$(this));" id="submitbtn"/>
