<?php if ($this->_var['page_info']['page_links']): ?>
<div class="clearfix">
  <div class="page page-top"> <b class="total"><?php echo $this->_var['page_info']['curr_page']; ?>/<?php echo $this->_var['page_info']['page_count']; ?></b> 
