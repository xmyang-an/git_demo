...
function send_test_email(){
    ...
    $.ajax({
        ...
        error: function(){parent.layer.alert('测试邮件发送失败，请重新配置邮件服务器');}
    });
}
</script>
        ...
        <table class="infoTable">
            ...
            <tr>
                <th class="paddingT15">
                    测试邮件地址:</th>
                <td class="paddingT15 wordSpacing5">
                <input class="infoTableInput" id="email_test" type="text" name="email_test" value="<?php echo $this->_var['setting']['email_test']; ?>"/><input id="send_test_email" class="default-btn" type="button" name="send_test_email" value="测试" /></td>
            </tr>
            <tr>
            <th></th>
            <td class="ptb20">
