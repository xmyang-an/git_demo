    ...
    <form method="post">
        <table class="infoTable">
            <tr>
                ...
                <td class="paddingT15">
                    <span class="onoff">
                    <label class="cb-enable <?php if ($this->_var['config']['enabled_subdomain']): ?>selected<?php endif; ?>">启用</label>
                    <label class="cb-disable <?php if (! $this->_var['config']['enabled_subdomain']): ?>selected<?php endif; ?>">禁用</label>
                    <input name="enabled_subdomain" value="1" type="radio" <?php if ($this->_var['config']['enabled_subdomain']): ?>checked<?php endif; ?>>
                    <input name="enabled_subdomain" value="0" type="radio" <?php if (! $this->_var['config']['enabled_subdomain']): ?>checked<?php endif; ?>>
                  </span>
                <span class="grey notice">启用二级域名需要您的服务器支持，具体配置方便请查看安装包中docs目录中的二级域名配置文档</span>
                </td>
            </tr>
            <tr>
                <th class="paddingT15">
