...
<div id="rightTop">
  ...
  <ul class="subnav">
    ...
    <li><span><?php if ($this->_var['sgrade']['grade_id']): ?>编辑<?php else: ?>新增<?php endif; ?></span></li>
  </ul>
</div>
<div class="info">
...
?>
      ...
      <tr>
        ...
        <td class="paddingT15">
        	<span class="onoff">
                <label class="cb-enable <?php if ($this->_var['sgrade']['need_confirm']): ?>selected<?php endif; ?>">是</label>
                <label class="cb-disable <?php if (! $this->_var['sgrade']['need_confirm']): ?>selected<?php endif; ?>">否</label>
                <input name="need_confirm" value="1" type="radio" <?php if ($this->_var['sgrade']['need_confirm']): ?>checked<?php endif; ?>>
                <input name="need_confirm" value="0" type="radio" <?php if (! $this->_var['sgrade']['need_confirm']): ?>checked<?php endif; ?>>
            </span>
         </td>
      </tr>
      <tr>
