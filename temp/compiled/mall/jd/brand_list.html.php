...
<div id="main" class="clearfix"> <?php echo $this->fetch('member.menu.html'); ?>
  <div id="right"> <?php echo $this->fetch('member.curlocal.html'); ?>
    <div class="wrapful"> <?php echo $this->fetch('member.submenu.html'); ?>
      <div class="wrap">
        <div class="eject_btn_two eject_pos1" title="品牌申请"><b class="ico3" ectype="dialog" dialog_title="品牌申请" dialog_id="my_goods_brand_apply" dialog_width="480" uri="index.php?app=my_goods&act=brand_apply">品牌申请</b></div>
        <div class="public table">
          <table>
            <tr>
              <th colspan="4"> <div class="search_div clearfix mb20">
...
?>
            ...
            <?php endforeach; else: ?>
            <tr>
              <td colspan="4" class="padding6"><div class="notice-word">
                  <p>没有符合条件的商品</p>
                </div></td>
            </tr>
            ...
            <tr>
              <td colspan="4"><div class="position2 clearfix"> <?php echo $this->fetch('member.page.bottom.html'); ?> </div></td>
            </tr>
            <?php endif; ?>
          </table>
        </div>
