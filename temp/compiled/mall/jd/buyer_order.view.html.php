...
?>
					<div class="ware_list">
						...
						<div class="ware_text">
							<div class="ware_text1"> <a href="<?php echo url('app=goods&id=' . $this->_var['goods']['goods_id']. ''); ?>"><?php echo htmlspecialchars($this->_var['goods']['goods_name']); ?></a> <br />
...
?>
					<div class="ware_list relative">
						...
						<div class="ware_text">
							<div class="ware_text1"> <a href="<?php echo url('app=gift&id=' . $this->_var['goods']['goods_id']. ''); ?>"><?php echo htmlspecialchars($this->_var['goods']['goods_name']); ?></a><em class="label-gift">赠品</em></div>								
							<div class="ware_text2"> <span>数量&nbsp;:&nbsp;<strong><?php echo $this->_var['goods']['quantity']; ?></strong></span> <span>价格&nbsp;:&nbsp;<strong><?php echo price_format($this->_var['goods']['price']); ?></strong></span> </div>
						</div>
					</div>
					<?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
					
					<div class="transportation">运费&nbsp;:&nbsp;<span><?php echo price_format($this->_var['order_extm']['shipping_fee']); ?><strong>(<?php echo htmlspecialchars($this->_var['order_extm']['shipping_name']); ?>)</strong></span>优惠打折&nbsp;:&nbsp;<span><?php echo price_format($this->_var['order']['discount']); ?></span>总价&nbsp;:&nbsp;<b><?php echo price_format($this->_var['order']['order_amount']); ?></b>&nbsp;&nbsp;&nbsp;&nbsp;
					<a href="<?php echo url('app=cashier&order_id=' . $this->_var['order']['order_id']. ''); ?>" target="_blank" id="order<?php echo $this->_var['order']['order_id']; ?>_action_pay" style="overflow:unset;<?php if ($this->_var['order']['status'] != ORDER_PENDING): ?> display:none<?php endif; ?>" class="btn-order-status-pay btn-alipay">付款</a>
					</div>
