...
.btn {border:1px #06F solid; color:#06F; display:block; float:left; height: 26px; line-height:26px; margin: 0 3px; text-align:center; text-decoration:none; width:78px; border-radius:4px;}
.btn:hover{color:#06F;}
.f_l{float:left;}
      ...
      <div class="wrap">
        <div class="public">
          <form method="post" enctype="multipart/form-data" id="goods_form">
            ...
            <div class="send_out">
              <input class="btn-alipay" style="width:200px;" type="submit" value="导入" />
            </div>
            </ul>
