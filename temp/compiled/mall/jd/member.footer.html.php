<div id="footer" class="w-full member-footer">
  <div class="foot-group w clearfix center">
    <div class="footnav">
      ...
      <div class="copy">
        <p style="font-size:13px;">Copyright &copy; 2015-2020 <a href="#" class="ml5 mr5"></a> 壹点网 版权所有<?php if ($this->_var['icp_number']): ?><a href="http://www.miibeian.gov.cn" target="_blank" style="margin-right:20px;"><?php echo $this->_var['icp_number']; ?></a><?php endif; ?><?php echo $this->_var['statistics_code']; ?></p>
      </div>
    </div>
  </div>
</div>
