                ...
                <form method="post" enctype="multipart/form-data" id="send_form" action="index.php?app=message&act=send">
                  <ul>
                    <li>
                      <h3>收件人: </h3>
                      <p>
                        <input type="text" class="text width_normal" name="to_user_name" value="<?php echo htmlspecialchars($_GET['to_user_name']); ?>"/>
                        <span class="field_notice">多个收件人请用逗号分隔开</span></p>
                    </li>
                    <li>
                      <h3>内容: </h3>
                      <p>
                        <textarea class="text width_long" name="msg_content" />
                        </textarea>
                      </p>
                      <div class="clear"></div>
                  ...
                  <div class="submit">
                    <input type="submit" class="btn" value="确认发送" />
                  </div>
                </form>
              </div>
              <div class="friend">
                <h2>我的好友(<?php echo $this->_var['friend_num']; ?>)</h2>
                <ul>
