      ...
      <div class="wrap">
        <div class="public">
          <div class="message message_line"> 
            ...
            <h2> <span>&nbsp;</span> <a class="delete" href="javascript:drop_confirm('您确定要删除它吗？', 'index.php?app=message&amp;act=drop_relate&amp;back=<?php echo $this->_var['box']; ?>&amp;msg_id=<?php echo $this->_var['message']['msg_id']; ?>');">删除</a> </h2>
            <?php else: ?>
            ...
            <div class="message_con">
              <div class="user">
                ...
                <h3><span><?php echo htmlspecialchars($this->_var['message']['user_name']); ?></span><br />
                  <?php echo local_date("Y-m-d H:i",$this->_var['message']['add_time']); ?></h3>
              </div>
...
?>
            <div class="message_con">
              <div class="user">
                ...
                <h3><span><?php echo htmlspecialchars($this->_var['reply']['user_name']); ?></span><br />
                  <?php echo local_date("Y-m-d H:i",$this->_var['reply']['add_time']); ?></h3>
              </div>
