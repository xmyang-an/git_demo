          ...
          <div class="info2">
            <form method="post" id="delivery_template">
              <table class="infoTable" align="center">
                ...
                <tr>
                  <td align="left" width="80" height="25">配送方式：</td>
...
?>
                      <div class="section mb10">
                        <p>
                          ...
                          <label for="input_<?php echo $this->_var['type']; ?>"><?php echo delivery_name($this->_var['type']); ?></label>
                        </p>
...
?>
                      <div class="section">
                        <p>
                          ...
                          <label for="input_<?php echo $this->_var['item']; ?>"><?php echo delivery_name($this->_var['item']); ?></label>
                        </p>
                        <div class="postage-detail" id="<?php echo $this->_var['item']; ?>">
                          <div class="default_fee">
                            <label>默认运费：</label>
                            <input type="hidden" name="<?php echo $this->_var['item']; ?>_dests[]" value="1" />
                            <input type="text" class="input" value="1" name="<?php echo $this->_var['item']; ?>_start[]" />
                            <label>件内，</label>
                            <input type="text" class="input" value="10" name="<?php echo $this->_var['item']; ?>_postage[]" />
                            <label>元，</label>
                            <label>每增加</label>
                            <input type="text" class="input" value="1" name="<?php echo $this->_var['item']; ?>_plus[]" />
                            <label>件，</label>
                            <label>增加运费</label>
                            <input type="text" class="input" value="0" name="<?php echo $this->_var['item']; ?>_postageplus[]" />
                            <label>元</label>
                          </div>
                          <div class="other_fee">
                ...
                <tr>
                  <td></td>
                  <td height="50"><span class="btn-alipay">
                    <input type="submit" value="提交" class="submit J_SubmitDelivery" />
                    </span></td>
                </tr>
              </table>
            </form>
