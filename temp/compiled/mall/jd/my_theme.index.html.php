...
?>
                <li>
                  ...
                  <h2>模板名称: <?php echo htmlspecialchars($this->_var['theme']['template_name']); ?><br />
                    风格名称: <?php echo htmlspecialchars($this->_var['theme']['style_name']); ?></h2>
                  <span> <a href="javascript:use_theme('<?php echo htmlspecialchars($this->_var['theme']['template_name']); ?>', '<?php echo htmlspecialchars($this->_var['theme']['style_name']); ?>');" class="employ">使用</a> <a href="javascript:preview_theme('<?php echo htmlspecialchars($this->_var['theme']['template_name']); ?>', '<?php echo htmlspecialchars($this->_var['theme']['style_name']); ?>','<?php echo $_GET['act']; ?>');" class="preview">预览</a> </span> </li>
